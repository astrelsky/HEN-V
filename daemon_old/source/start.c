...
int __attribute__ ((naked, weak, noinline)) mdbg_call(void) {
	__asm__ volatile(
		"mov $573, %rax\n"
...
int __attribute__ ((naked, weak, noinline)) ptrace(void) {
	__asm__ volatile(
		"mov $26, %rax\n"
		"jmp *syscall_addr(%rip)\n"
	);
...
int __attribute__ ((naked, weak, noinline)) nmount(void) {
	__asm__ volatile(
		"mov $378, %rax\n"
		"jmp *syscall_addr(%rip)\n"
	);
